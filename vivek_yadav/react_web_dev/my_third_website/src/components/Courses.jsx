...
//Import courses images-replace with your actual image
import courses1 from "../assets/course1.jpg";
import courses2 from "../assets/course2.jpg";
import courses3 from "../assets/course3.jpg";
    ...
    const courses = [
        {
            ...
            description:
            "Master HTML, CSS, JavaScript, React, and Node.js. Build real-word projects.",
            price: "₹29,999",
            duration: "6 months",
            image: courses1,
        ...
        },
        {
            ...
            duration: "4 months",
            image: course3,
            features: ["Google Certifcations", "Live Campaigns","Job Assestance"],
        },
        {
            id: 4,
        ...
        },
        {
          ...
          title: "Cyber Securty",
          description:
          "Network Securty , Ethical Hacking, and Securty Compliance.",
          price: "₹44,999",
          duration: "8 months",
          image: course2,
        ...
        },
        {
            ...
            description: "AWS, Azure, Google Cloud, DevOps, and Contaunerization.",
            price: "₹6 months",
            image: courses3,
